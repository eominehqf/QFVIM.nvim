return {
  ...
  dependencies = {
      ...
      "rafamadriz/friendly-snippets", -- 预定义的片段集合
  ...
  opts = function()
      ...
      require("luasnip.loaders.from_vscode").lazy_load() -- 加载 VSCode 风格的片段
      require("luasnip.loaders.from_lua").lazy_load({ paths = "~/.config/nvim/lua/snippets/" }) -- 加载自定义片段
      return {
          snippet = {
